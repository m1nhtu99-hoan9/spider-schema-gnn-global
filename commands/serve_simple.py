"""
(c) allennlp/allennlp-server, Apache-2 licensed
...
def _get_predictor(args: argparse.Namespace) -> Predictor:
    ...
    tar_archive = load_archive(archive_file=args.archive_path, cuda_device=args.cuda_device, overrides=args.overrides)
